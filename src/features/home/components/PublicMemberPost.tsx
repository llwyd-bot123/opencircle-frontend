...
export const PublicMemberPost = ({
  ...
  return (
    <div className="bg-white rounded-xl p-4 sm:p-6 shadow-sm border border-gray-100 w-full">
      ...
      <div className="flex flex-row items-center justify-between mb-4">
        <div className="flex flex-row items-center space-x-2 sm:space-x-3">
          <ProfileAvatar
            ...
            type={isAuthorOrganization ? "organization" : "member"}
            isOwner={isOwner}
      ...
      {/* Description */}
      <div className="px-4 text-primary leading-relaxed">
        ...
        <div className="grid grid-cols-2 gap-2 mt-4">
          {imageUrls.slice(0, 4).map((src, idx) => (
            <button
              key={idx}
              type="button"
              className="w-full h-40 sm:h-48 md:h-56 lg:h-[300px] rounded-lg overflow-hidden relative cursor-pointer"
